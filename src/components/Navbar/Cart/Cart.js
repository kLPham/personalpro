...
export default class Cart extends Component {
  ...
  handleCartRemove(product) {
    axios
      ...
      .catch(console.log);
    alert(
      'Congratulation! You now have more than a dollar in your bank account'
    );
  }
          ...
          return (
            <div className="cart_container">
              ...
              <Trash
                className="trash"
                id="Cart_trash"
                onClick={() => this.handleCartRemove(product)}
              />
            </div>
          );
        })
    ...
    return (
      <div>
        <div className="btn_container">
          <button className="continuebtn" onClick={this.backToProductPage}>
            CONTINUE SHOPPING
          </button>
          <br />
        ...
        <div className="my_cart">
          ...
          <div className="checkoutContainer">
            ...
            <div className="totalcontainer">
              <p className="total">
                <br />ORDER TOTAL: ${this.state.cart.length &&
